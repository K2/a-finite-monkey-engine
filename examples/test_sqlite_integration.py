#!/usr/bin/env python3
"""
Test script for SQLite database integration in core_async_analyzer
"""
...
async def test_store_expressions():
    """Test storing expressions in a SQLite database"""
    # Use SQLite for testing
    db_url = "sqlite+aiosqlite:///test_db.sqlite"
    logger.info(f"Using database URL: {db_url}")
    
    # Make sure the database directory exists
    os.makedirs(os.path.dirname(os.path.abspath("test_db.sqlite")), exist_ok=True)
